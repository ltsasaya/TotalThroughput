...
export function QueueDiagram() {
  return (
    <figure className="retro-manual-diagram retro-manual-diagram-queue" aria-label="Server queue and worker diagram">
      <svg viewBox="0 0 620 330" role="img" aria-labelledby="queue-diagram-title queue-diagram-desc">
        ...
        <desc id="queue-diagram-desc">
          A client sends a request into the server. Inside the server, the request
        ...
        <text className="queue-diagram-small" x="82" y="128" textAnchor="middle">Client</text>
        ...
        <text className="queue-diagram-label" x="375" y="105" textAnchor="middle">Server</text>
